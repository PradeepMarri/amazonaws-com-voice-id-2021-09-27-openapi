...
func ListtagsforresourceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=VoiceID.ListTagsForResource", cfg.BaseURL)
...
func CreateListtagsforresourceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=VoiceID_ListTagsForResource",
		mcp.WithDescription("Lists all tags associated with a specified Voice ID resource."),
