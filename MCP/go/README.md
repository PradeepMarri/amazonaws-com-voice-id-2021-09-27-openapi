# Amazon Voice ID MCP Server

This MCP (Model Content Protocol) server provides access to Amazon Voice ID API functionality through HTTP, HTTPS, and STDIO transport modes.
